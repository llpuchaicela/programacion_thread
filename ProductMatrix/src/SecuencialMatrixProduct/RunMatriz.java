package SecuencialMatrixProduct;

import SecuencialMatrixProduct.Matriz;
...
public class RunMatriz {
    ...
    //Metodo para verificar si vale el metodo de fila y columnas
    private static void printArray(int[] arr, boolean vertical) {
        var escapeSquence = vertical ? "\n" : "\t";
// ? Operador ternario
        // vertical  ? es igual a un if o else con \n y \t
